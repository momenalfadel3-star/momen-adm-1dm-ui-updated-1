...
class DownloaderConfig {
  ...
  DownloaderConfig({
    this.downloadDir = '',
    // 1DM-like experience: allow up to 256 parallel tasks by default.
    // Users can still change it in Settings.
    this.maxRunning = 256,
  });
...
class HttpConfig {
  ...
  HttpConfig({
    this.userAgent = '',
    // Keep Gopeed's power-user defaults: 256 connections like your requested setup.
